...
{
	mysql_query("UPDATE galleryphotos SET SortOrder='$cred' WHERE PhotoID='$cid'") or die("cred update :".mysql_error());
...
else
{
	...
	echo "<input type=\"text\" id=\"sort_".$cid."\" value=\"".$oldr['SortOrder']."\" style=\"width: 50px;\">";
}
