...
if(isset($_POST['gallery_sub'])){
	...
	if(isset($_POST['gallery_name'])){
		...
		if(!empty($gallery_name)){
			...
			$date=date('Y-m-d');
			mysql_query("INSERT INTO gallery (GalleryName,Description,DateAdded,SortOrder) values ('$gallery_name','$gallery_desc','$date','$gallery_sort')") or die ("insert gallery error : ". mysql_error());
			$gallery_id=mysql_insert_id();
			
			$path_full="../images/gallery/$gallery_id";
         ...
         $second=$_POST['second'];
            ...
            $filesecond=clean(trim($second[$ctr]));
				...
				if(!empty($datafile))
				{
					mysql_query("INSERT INTO galleryphotos (GalleryID,Caption,Credits,SortOrder,Filename,ImageThumb,ImageSecond) VALUES ('$gallery_id','$filecaption','$filecredits','$filesort','$datafile','$filethumbs','$filesecond')") or die ("photo error :".mysql_error());
					/*$photoID=mysql_insert_id();
					
					$file=$photoID."_photos.jpg";
					mysql_query("UPDATE galleryphotos SET Filename='$file' WHERE PhotoID='$photoID';") or die("update gall photo : ".mysql_error());
...
if(isset($_POST['image_add_sub']))
{
	...
	$add_datafile=$_POST['image_add'];
				...
				if(!empty($add_datafile))
				{
					...
					$add_path_full="../images/gallery/$add_gallery_id";
               $add_thumbs=clean(trim($_POST['thumbs_add']));
               $add_second=clean(trim($_POST['second_add']));
					//echo $add_cap."<br />". $add_cred;
					mysql_query("INSERT INTO galleryphotos (GalleryID,Caption,Credits,SortOrder,Filename,ImageThumb,ImageSecond) VALUES ('$add_gallery_id','$add_cap','$add_cred','$add_sort','$add_datafile','$add_thumbs','$add_second')") or die ("photo error :".mysql_error());
					/*$add_photoID=mysql_insert_id();
					
					$add_file=$add_photoID."_photos.jpg";
					mysql_query("UPDATE galleryphotos SET Filename='$add_file' WHERE PhotoID='$add_photoID';") or die("update gall photo : ".mysql_error());
...
function imageAdd(){
	...
	$("#image_upload").append('<div id="upload_'+imagenum+'" style="display: block; margin-top:2px; padding-top: 3px; border-top: 1px solid #000000;"><table><tr><td>Caption</td><td><input type="text" name="caption[]"><input type="button" value="Remove" onclick="imageRemove('+imagenum+')"></td></tr><tr><td>Credits:</td><td><input type="text" name="credits[]"></td></tr><tr><td>Main Image:</td><td><input type="text" name="image[]"> (600x600)</td></tr><tr><td>Thumbnail:</td><td><input type="text" name="thumbs[]"> (282x282 max)</td></tr><tr><td>Thumbnail:</td><td><input type="text" name="second[]"> (301x200)</td></tr><tr><td>Sort Order:</td><td><input type="text" name="sort[]" style="width: 50px;" ></td></tr></table></div>');
	imagenum++;
}
...
<body>
   ...
   <div id="error"></div>
   <h3>PHOTO GALLERY</h3>
      <form action="gallery.php" id="gallery_form" name="gallery_form" method="post" enctype="multipart/form-data">
         <table>
            <tr>
               <td>
                  Gallery Name:
                        ...
                        <table>
                           ...
                           <tr>
                              ...
                              <td>
                                 ...
                                 <input type="text" name="image[]"> (600x600)
                              </td>
                           </tr>
                           <tr>
                              <td>
                              ...
                              <td>
                                 <input type="text" name="thumbs[]"> (282x282 max)
                              </td>
                           </tr>
                           <tr>
                              <td>
                              ...
                              <td>
                                 <input type="text" name="second[]"> (301x200)
                              </td>
                           </tr>
                           <tr>
                              <td>
...
$results = mysql_query("select * from gallery order by GalleryID limit $page, $page_max");
$count = 0;
$row_ctr=1;
...
?>		
	<div style="width: 1000px; margin-top: 3px;">
		<input type="hidden" id="gall_id_<?php echo $row_ctr;?>" value="<?php echo $row['GalleryID'];?>">
		<input type="hidden" id="ctr_id_<?php echo $row['GalleryID'];?>" value="<?php echo $row_ctr;?>">
		<div style="width: 950px; background: #ccc;display: inline-block; padding-left: 4px;">
			<span id="test_<?php echo $row['GalleryID'];?>" style="display: inline-block;">
            <table>
               <tr>
                  <td>
                     Gallery Name:
                  ...
                  <td>
                     <input type="text" id="gname_<?php echo $row['GalleryID'];?>" value="<?php echo $row['GalleryName'];?>" style="width: 300px;">
                  </td>
               </tr>
               <tr>
                  <td>
                  ...
                  <td>
                     <input type="text" id="gdesc_<?php echo $row['GalleryID'];?>" value="<?php echo $row['Description'];?>" style="width: 300px;">
                  </td>
               </tr>
               <tr>
                  <td>
                  ...
                  <td>
                     <input type="text" id="gsort_<?php echo $row['GalleryID'];?>" value="<?php echo $row['SortOrder'];?>" style="width: 50px;">
                  </td>
               </tr>
            </table>
			</span><br /><input type="button" value="save" onclick="saveInfo(<?php echo $row['GalleryID'];?>);">
			<div id="gallery_status_<?php echo $row_ctr;?>" style="float: right;">
				Status : <?php 
						...
						?>
				<input type="button" value="<?php echo $change_stat;?>" onclick="changeStat(<?php echo $row['GalleryID'];?>)">
			</div>
		</div>
			...
			<div style="width: 978px; margin-left: 10px;">
               ...
               <table>
                  <tr>
                     ...
                     <td>
                        <input type="text" name="caption_add" id="caption_add_<?php echo $row['GalleryID'];?>">
                     </td>
                  </tr>
                  <tr>
                     <td>
                     ...
                     <td>
                        <input type="text" name="credits_add" id="credits_add_<?php echo $row['GalleryID'];?>">
                     </td>
                  </tr>
                  <tr>
                     <td>
                     ...
                     <td>
                        <!--input type="file" name="image_add" id="image_add_<?php echo $row['GalleryID'];?>"-->
                        <input type="text" name="image_add" id="image_add_<?php echo $row['GalleryID'];?>"> (600x600)
                        <input type="hidden" name="image_add_id" value="<?php echo $row['GalleryID'];?>">
                        <!--<input type="submit" value="upload" onclick="addToGallery(<?php //echo $row['GalleryID'];?>)">-->
                     </td>
                  </tr>
                  <tr>
                     <td>
                     ...
                     <td>
                        <input type="text" name="thumbs_add" id="thumbs_add_<?php echo $row['GalleryID'];?>"> (282x282 max)
                     </td>
                  </tr>
                  <tr>
                     <td>
                     ...
                     <td>
                        <input type="text" name="second_add" id="second_add_<?php echo $row['GalleryID'];?>"> (301x200)
                     </td>
                  </tr>
                  <tr>
                     <td>
                     ...
                     <td>
                        <input type="text" name="sort_add" id="sort_add_<?php echo $row['SortOrder'];?>" style="width: 50px; " >
                     </td>
                  </tr>
                  <tr>
                     <td colspan="2">
