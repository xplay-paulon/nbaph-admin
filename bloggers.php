...
if ($_POST['blogid']) {
   if ($_POST['action'] == "edit") {
      $results = mysql_query("select * from blog where BlogID = '" . $_POST['blogid'] . "'");
      ...
      mysql_query("delete from blog where BlogID = '" . mysql_real_escape_string($_POST['blogid']) . "'");
   }
   else {
...
<body>
   ...
   <div id="main">
      <form action="bloggers.php?page=<?php echo $_GET['page']; ?>" id="poll_form" name="poll_form" method="post" enctype="multipart/form-data">
         ...
         <table>
            ...
            <tr>
               ...
               <td>
                  <textarea name="blogexcerpt" rows="5" cols="30"><?php echo stripslashes($row['BlogExcerpt']); ?></textarea>
               </td>
            </tr>
            <tr>
               <td>
               ...
               <td>
                  <textarea name="blogbody" id="blogbody"><?php echo stripslashes($row['BlogBody']); ?></textarea>
               </td>
            </tr>
            <tr>
               <td>
...
$results = mysql_query("select * from blog order by BlogID limit $page, $page_max");
...
?>
         <tr<?php echo $style; ?>>
            ...
            <td>
               <form action="bloggers.php?page=<?php echo $_GET['page']; ?>" method="post" onsubmit="return verify_delete(<?php echo $row['BlogID']; ?>)">
...
for ($i = 0; $i < $total; $i += 1) {
   if ($i * $page_max == $page)
      ...
      echo '<a href="bloggers.php?page=' . $i . '">' . ($i + 1) . '</a>';
