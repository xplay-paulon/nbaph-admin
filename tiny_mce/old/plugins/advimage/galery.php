...
$GDok = TRUE;
// ------------ config section --------------------
$IMGFOLDER = '../../../../beta-store/newsImages';
$IMGURL = 'http://staging.forthmedia.net/winestory/beta-store/newsImages';
$VIDEOICON = 'video.jpg';
$AUDIOICON = 'audio.jpg';
// language setting   en
$LARGEIMG = 'View Image';
...
function make_thumb($img_name,$filename,$new_w,$new_h) {
  ...
  if(!strcmp("GIF",$ext))
    $src_img=ImageCreateFromGIF($img_name);
  if(!strcmp("png",$ext)) {
    $src_img=ImageCreateFromPng($img_name);    return;  }
  if(!strcmp("PNG",$ext)) {
    $src_img=ImageCreateFromPng($img_name);    return;  }
  if (isset($src_img)) {
    if ($src_img != '') {
  ...
  if (count($file_lista) > 0) {
   ...
   print '</tr></table>'."\n";
	...
	<script language="javascript">
		window.top.window.finishupload();
	</script>
<?php
} //function makejsdir
...
print "<p width=100% id='title'>$HELPSTR</p>\n";
print '<iframe id="frm1" name="frm1" width="450" height="220" src="./galery.php?act=list"></iframe>'."\n";
...
print '<p id="imgalt">&nbsp;</p>'."\n";
print "<p width=100% id='title'>Upload New Image :</p>\n";
...
print "<button type=button onclick=\"uploadimg();\">$UPLOADIMG</button> <img src=\"/ems/preloader.gif\" border=\"0\" width=\"32\" height=\"32\" alt=\"please wait...\" align=\"middle\" style=\"visibility: hidden\" id=\"loader\"><br />\n";
print "</center>\n";
print "</form>\n";
print "</center>\n";
?>
