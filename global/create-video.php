	   		...
	   		<div class='well'>
		   		<form method='POST' class='form-horizontal' action='/admin/global-games.php?crud=sv'>
		   			...
		   			<div class='control-group'>
		   				...
		   				<div class='controls'>
		   					<textarea class='span4' id='inputEmbeddedCode' name='inputEmbeddedCode'></textarea>
		   				</div>
		   			</div>	
		   			<div class='control-group'>
		   				<label class='control-label' for='inputImageLink'>Thumbnail</label>
		   				<div class='controls'>
		   					<input class='span4' type='text' id='inputImageLink' name='inputImageLink' placeholder='Enter Image Link here' value=''/><span style='display:inline-block; margin:10px 10px;'> Size : 150x84px</span>
		   				</div>
		   			</div>	   			
		   			<div class='control-group'>
