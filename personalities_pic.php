...
?>
         <tr<?php echo $style; ?>>
            ...
            <td>
<?php
   if (file_exists("../images/personalities/" . strtolower(urlencode(str_replace("ñ", "n", $row['Blogger']))) . ".jpg")) {
?>
               <img src="../images/personalities/<?php echo strtolower(urlencode(str_replace("ñ", "n", $row['Blogger']))); ?>.jpg">
<?php
   }
   else {
      echo "no picture";
